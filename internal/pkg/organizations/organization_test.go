...
//	suite.Assertions.Equal(false, isValid, "Expected New() to return a stub that does not pass validation")
//
...
//	suite.Assertions.Equal(true, isValid, "Expected Org to pass validation")
//	suite.Assertions.Equal(0, len(errs), "Expected no errors when validation passes")
//
//	// Set an invalid slug
//	o = &Organization{
//		Id:            0,
...
//
//	isValid, _ = o.Validate()
//	suite.Assertions.Equal(false, isValid, fmt.Sprintf("Expected slug '%s' to be invalid, but successfully validated", o.Slug))
//}
